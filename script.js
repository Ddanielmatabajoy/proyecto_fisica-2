...
const questionsBase = [
  {
    question: "¿Que tipo de carga electrica tienen los protones?",
  ...
  {
    question: "Una particula con carga positiva se mueve en la dirección del campo electrico porque:",
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: "I = ”Q/”t: cantidad de carga que atraviesa una seccion por unidad de tiempo."
  },
  {
  ...
  },
  {
    ...
    options: ["Energía potencial del agua almacenada","Radiacion solar","Calor del subsuelo","Movimiento de las olas"],
    correctIndex: 0,
    explanation: "Se basa en la energía potencial gravitatoria del agua embalsada que se convierte en electrica."
  },
  {
    question: "Una ventaja de las energias renovables es que:",
    options: ["Aumentan el CO‚","Son mas contaminantes","Reducen el impacto ambiental","No generan energia suficiente"],
    correctIndex: 2,
